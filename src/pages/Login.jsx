...
function isInAppBrowser() {
  return /Line|FBAN|FBAV|Instagram|Twitter|MicroMessenger/i.test(navigator.userAgent)
}
      ...
      <div className="login-card">
        ...
        {inApp ? (
          <div className="inapp-warning">
            <div className="inapp-warning-icon">⚠️</div>
            <p>目前在 App 內建瀏覽器中，<br />無法使用 Google 登入。</p>
            <p className="inapp-hint">請用 <strong>Safari</strong> 或 <strong>Chrome</strong> 開啟此頁面：</p>
            <div className="inapp-url">{window.location.href}</div>
          </div>
        ) : (
